...
The authoritative submitted-looking raster images are in `../figures/`:

- four final V4 composite figures in `../figures/Figure1.png` through
  `Figure4.png`;
- 20 author-supplied panel exports in `../figures/panels/`;
...
the frozen PNG files, rather than a fresh local rasterization, define the exact
0814 visual snapshot.
...
The V4 manuscript removed two intermediate package panels and then closed the
letter gaps during final assembly:
